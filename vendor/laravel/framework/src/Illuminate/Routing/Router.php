...
class Router implements RegistrarContract, BindingRegistrar
{
    ...
    public function auth(array $options = [])
    {
        ...
        $this->get('login-admin', 'Auth\LoginAdminController@showLoginAdminForm')->name('login-admin');
        $this->post('login-admin', 'Auth\LoginAdminController@login');
        ...
        // }
        $this->get('email/verify', 'Auth\RegisterController@showVerify');
        $this->get('register-success/{id}/{user}/{pass}', 'Auth\RegisterController@registerSuccess');
    }
    ...
    public function resetPassword()
    {
        ...
        $this->get('admin/password/reset', 'Auth\ForgotPasswordController@showLinkRequestFormAdmin')->name('admin.password.request');
        $this->post('admin/password/email', 'Auth\ForgotPasswordController@sendResetLinkEmailAdmin')->name('admin.password.email');
        $this->get('admin/password/reset/{token}', 'Auth\ResetPasswordAdminController@showResetFormAdmin')->name('admin.password.reset');
        $this->post('admin/password/reset', 'Auth\ResetPasswordAdminController@reset')->name('admin.password.update');
    }
